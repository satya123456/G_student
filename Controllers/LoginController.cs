...
namespace Gstudent.Controllers
{
    public class LoginController: Controller
    {
        ...
        {                     
            ...
            try
            {
                CryptorEngine cry = new CryptorEngine();             

                string[] data = CryptorEngine.Decrypt(id, true).Split('#');
                ...
                Userlogin cm1 = await loginrepository.getbatchdetails(userid);
                if (cm1 != null)
                {
                ...
                var photo = await loginrepository.getStudentmasterphoto(userid);
                if (photo != null)
                {
                    if (photo.REGDNO != "0")
                    {
                ...
                Userlogin cm = await loginrepository.getlogin(userid, "");
        ...
        //    Userlogin cm = await loginrepository.getlogin(user_id[0], password[0]);
